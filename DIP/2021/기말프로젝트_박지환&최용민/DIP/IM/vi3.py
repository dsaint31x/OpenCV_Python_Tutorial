...
class A:    
    def __init__(self):
        ...
        aa=Label(self.window,text='[주의] CLAHE와 global_HE 중 하나만 선택해 주세요', bg='#ff0', fg='#f00').grid(row=0, column=1)
        ...
        g3=Label(self.window,wraplength =260, text='(color 옵션 :  0(COLOR_UNCHANGED) : 그대로 / 11(COLOR_GRAY) : grayscale / 12(COLOR_BGR) : BGR [default=0])').grid(row=17,column=2, sticky='w')
