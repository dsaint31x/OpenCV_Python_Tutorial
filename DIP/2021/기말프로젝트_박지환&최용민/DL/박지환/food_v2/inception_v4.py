...
# [출처] https://github.com/titu1994/Inception-v4/blob/master/inception_v4.py
...
def conv_block(x, nb_filter, nb_row, nb_col, border_mode='same', subsample=(1, 1), bias=False):
    ...
    x = Convolution2D(filters=nb_filter, kernel_size=(nb_row, nb_col), strides=subsample, padding=border_mode, use_bias=bias)(x)
